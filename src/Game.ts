  ...
  private update(dt: number): void {
    ...
    if (!this.player.isAlive) {
      ...
      if (this.deathTimer >= 2.0) {
        ...
        console.log(`[DEBUG] Before revive: maxHp=${this.player.stats.maxHp}, hp=${this.player.stats.hp}`);
        this.player.stats.hp = Math.floor(this.player.stats.maxHp * 0.5);
        console.log(`[DEBUG] After revive: maxHp=${this.player.stats.maxHp}, hp=${this.player.stats.hp}`);
